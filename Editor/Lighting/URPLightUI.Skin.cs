...
{
    partial class URPLightUI
    {
        sealed class HDStyles
        {
            // Headers
        ...
        static HDStyles s_Styles = new HDStyles();
        ...
        internal static class Styles
        {
            ...
            public static readonly GUIContent areaIntensity = EditorGUIUtility.TrTextContent("Intensity (Lumen)", "Luminous power of the Light in Lumen.");
