...
namespace UnityEngine.Rendering.Universal
{
    ...
    public partial class AdditionalLightData : MonoBehaviour, ISerializationCallbackReceiver, IAdditionalData
    {
        ...
        const float HARDCODED_EXPOSURE_EV100 = 15f; // Sunlight exposure. this translates to approximately EV15-16 in camera terms.
...
#pragma warning restore 0414
        ...
        void Update()
        {
            // No longer need to check for exposure volume component since we use hardcoded values
        }
